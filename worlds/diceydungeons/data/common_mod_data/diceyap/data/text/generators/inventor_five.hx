...
//Floor 3:
items = [];
gooditems = runscript("diceyap/load_ap_items_by_category", [generator, episode, "chests", "3", "1"]);
...
goodotherstuff = [shop(runscript("diceyap/load_ap_items_by_category", [generator, episode, "shops", "4", "1"]))];
