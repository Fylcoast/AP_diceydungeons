...
//Floor 2:
items = [];
gooditems = runscript("diceyap/load_ap_items_by_category", [generator, episode, "chests", "2"]);
otherstuff = [health()];
...
goodotherstuff = [
  upgrade(),
  shop(["upgrade", runscript("diceyap/load_ap_items_by_category", [generator, episode, "shops", "5", "1"])[0], "health"], [4, 4, 4])
];
