...
reward = runscript("diceyap/load_upgraded_level_items_by_category", [generator, episode, "levels", "", "2"]);
if (reward.length == 1 && (reward.indexOf("Dice") >= 0 || reward.indexOf("CPU:2") >= 0)) {
    leveluprewards(2, reward[0]);
} else {
    leveluprewards(2, "", reward);
}

reward = runscript("diceyap/load_upgraded_level_items_by_category", [generator, episode, "levels", "", "3"]);
if (reward.length == 1 && (reward.indexOf("Dice") >= 0 || reward.indexOf("CPU:2") >= 0)) {
...
reward = runscript("diceyap/load_upgraded_level_items_by_category", [generator, episode, "levels", "", "4"]);
if (reward.length == 1 && (reward.indexOf("Dice") >= 0 || reward.indexOf("CPU:2") >= 0)) {
...
reward = runscript("diceyap/load_upgraded_level_items_by_category", [generator, episode, "levels", "", "5"]);
if (reward.length == 1 && (reward.indexOf("Dice") >= 0 || reward.indexOf("CPU:2") >= 0)) {
...
reward = runscript("diceyap/load_upgraded_level_items_by_category", [generator, episode, "levels", "", "6"]);
if (reward.length == 1 && (reward.indexOf("Dice") >= 0 || reward.indexOf("CPU:2") >= 0)) {
